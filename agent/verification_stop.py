...
def _verification_snapshot(
    *,
    ...
    """Return ``(status, facts)`` for the first edited code workspace."""
    try:
    ...
    *,
    ...
    if verify_commands:
        ...
        command_instruction = (
            ...
            "`tempfile` path, run it against the changed behavior, clean it up "
            "when possible, and summarize it explicitly as ad-hoc verification "
